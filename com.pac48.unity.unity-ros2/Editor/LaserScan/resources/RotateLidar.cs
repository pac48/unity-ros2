...
public class RotateLidar : MonoBehaviour
{
    ...
    {
        get => this._numOfLayers;
    }

    public int numOfIncrements
    {
        get => this._numOfIncrements;
    }

    public float minAzimuthAngle
    {
        get => this._minAzimuthAngle;
    }

    public float maxAzimuthAngle
    {
        get => this._maxAzimuthAngle;
    }
    ...
    public Vector3[] commandDirVecs
    {
        get => this._commandDirVecs;
    }
    ...
    public void Init()
    {
        // allocate commands
        this.commands =
            new NativeArray<RaycastCommand>(this._numOfLayers * this._numOfIncrements, Allocator.Persistent);
        this._commandDirVecs = new Vector3[this.commands.Length];
        this.commandDirVecsNative =
            new NativeArray<Vector3>(this._numOfLayers * this._numOfIncrements, Allocator.Persistent);
        float vinc;
