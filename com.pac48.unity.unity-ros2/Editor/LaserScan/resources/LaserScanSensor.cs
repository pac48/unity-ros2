...
//     public float RangeMetersMin = 0.05f;
//     public float RangeMetersMax = 30;
...
//         ranges.Clear();
//         isScanning = false;
//         var now = (float) Time.timeAsDouble;
...
//             1 + Mathf.FloorToInt((float)(Time.timeAsDouble - m_TimeLastScanBeganSeconds) / TimeBetweenMeasurementsSeconds);
