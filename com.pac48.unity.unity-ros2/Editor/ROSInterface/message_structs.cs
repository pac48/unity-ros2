...
[MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]public double[] k;  // double
[MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]public double[] r;  // double
[MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)]public double[] p;  // double
...
[MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]public double[] magnetic_field_covariance;  // double
public string GetMsgType(){
...
public void Delete(){
 header.Delete();
  ...
  position.ptr = IntPtr.Zero;ROSInterface.Free(velocity.ptr);
  velocity.ptr = IntPtr.Zero;ROSInterface.Free(effort.ptr);
...
[MarshalAs(UnmanagedType.ByValArray, SizeConst = 36)]public double[] covariance;  // double
public string GetMsgType(){
...
public void Delete(){
 header.Delete();
  ...
  axes.ptr = IntPtr.Zero;ROSInterface.Free(buttons.ptr);
...
public void Delete(){
 header.Delete();
  ...
  cell_voltage.ptr = IntPtr.Zero;ROSInterface.Free(cell_temperature.ptr);
  cell_temperature.ptr = IntPtr.Zero;ROSInterface.Free(location);
...
public void Delete(){
 header.Delete();
  ...
  ROSInterface.Free(position.ptr);
  position.ptr = IntPtr.Zero;ROSInterface.Free(velocity.ptr);
  velocity.ptr = IntPtr.Zero;ROSInterface.Free(acceleration.ptr);
  acceleration.ptr = IntPtr.Zero;ROSInterface.Free(effort.ptr);
  effort.ptr = IntPtr.Zero;
...
[MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]public double[] position_covariance;  // double
...
public void Delete(){
 header.Delete();
  ROSInterface.Free(ranges.ptr);
  ranges.ptr = IntPtr.Zero;ROSInterface.Free(intensities.ptr);
  intensities.ptr = IntPtr.Zero;
...
public std_msgs_Header header;  // std_msgs_Header
public geometry_msgs_Quaternion orientation;  // geometry_msgs_Quaternion
[MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]public double[] orientation_covariance;  // double
public geometry_msgs_Vector3 angular_velocity;  // geometry_msgs_Vector3
[MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]public double[] angular_velocity_covariance;  // double
public geometry_msgs_Vector3 linear_acceleration;  // geometry_msgs_Vector3
[MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]public double[] linear_acceleration_covariance;  // double
public string GetMsgType(){
